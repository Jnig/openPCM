...
Ext.define('MyApp.controller.Virtualmachine', {
    ...
    onGridpanelItemDblClick: function(dataview, record, item, index, e, options) {
    ...
    vmstart: function(button, e, options) {
        this.vmaction('start');
    },

    vmshutdown: function(button, e, options) {
        this.vmaction('shutdown');
    },

    vmreset: function(button, e, options) {
        this.vmaction('reset');
    },

    vmdestroy: function(button, e, options) {
        this.vmaction('destroy');
    },

    vnc: function(button, e, options) {
    ...
    onTabpanelShow: function(abstractcomponent, options) {
        ...
        var iframe = abstractcomponent.down('#vnciframe');
