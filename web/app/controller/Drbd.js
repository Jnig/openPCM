...
Ext.define('MyApp.controller.Drbd', {
    ...
    onMenuitemClickEnableDrbd: function(item, e, options) {
    ...
    onComboboxBeforeQueryNodeA: function(queryEvent, options) {
    ...
    onComboboxBeforeQueryNodeB: function(queryEvent, options) {
